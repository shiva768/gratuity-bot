...
@ActiveProfiles("test")
public class SetEmojiNotifyChannelTest {
    @MockBean
    ...
    public void setup() {
        ...
        doNothing().when(dynamicSettingService).save(eq(DynamicSettingType.EmojiNotifyChannel.getKey()), anyLong(), captor.capture());
    }
    ...
    public void 成功_numeric() {
        ...
        new SetEmojiNotifyChannel(dynamicSettingService, messageSourceWrapper, discordValidatorService).execute(eventAdapter, locale);
        verify(eventAdapter, times(1)).getChannelByStringId("10");
        verify(dynamicSettingService, times(1)).save(eq(DynamicSettingType.EmojiNotifyChannel.getKey()), anyLong(), anyString());
    ...
    public void 失敗_ID空() {
        ...
        new SetEmojiNotifyChannel(dynamicSettingService, messageSourceWrapper, discordValidatorService).execute(eventAdapter, locale);
        verify(dynamicSettingService, times(0)).save(eq(DynamicSettingType.EmojiNotifyChannel.getKey()), anyLong(), anyString());
    ...
    public void 失敗_IDがただの文字列() {
        ...
        when(eventAdapter.getChannelByStringId(null)).thenReturn(null);
