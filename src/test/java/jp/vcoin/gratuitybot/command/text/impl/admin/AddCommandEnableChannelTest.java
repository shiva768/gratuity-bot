...
@ActiveProfiles("test")
public class AddCommandEnableChannelTest {
    ...
    public void setup() {
        ...
        doNothing().when(dynamicSettingService).save(eq(DynamicSettingType.CommandEnableChannel.getKey()), anyString(), anyLong(), captor.capture());
    }
    ...
    public void 成功_numeric() {
        ...
        new AddCommandEnableChannel(dynamicSettingService, messageSourceWrapper, discordValidatorService).execute(eventAdapter, locale);
        verify(eventAdapter, times(1)).getChannelByStringId("10");
        verify(dynamicSettingService, times(1)).save(eq(DynamicSettingType.CommandEnableChannel.getKey()), anyString(), anyLong(), anyString());
    ...
    public void 失敗_ID空() {
        ...
        new AddCommandEnableChannel(dynamicSettingService, messageSourceWrapper, discordValidatorService).execute(eventAdapter, locale);
        verify(dynamicSettingService, times(0)).save(eq(DynamicSettingType.CommandEnableChannel.getKey()), anyLong(), anyString());
